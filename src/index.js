...
if(Number(number.toString().slice(1)) === 00 && number >= 100){return hundreds[Number(number.toString().slice(0,1)) + 1]}//100,300
if(Number(number.toString().slice(1)) > 00 && number >= 100 && Number(number.toString().slice(1)) < 20)
